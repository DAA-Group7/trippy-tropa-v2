...
<div className="bg-background font-body-md text-foreground antialiased">

<nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-border/20 shadow-sm h-20">
...
<span className="font-['Inter'] font-semibold text-[24px] leading-[32px] font-bold text-primary">Trippy Tropa</span>
</div>
<div className="hidden md:flex gap-8 items-center">
<a className="text-foreground-variant hover:text-primary transition-colors font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em]" href="#features">Features</a>
<a className="text-foreground-variant hover:text-primary transition-colors font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em]" href="#how-it-works">How it Works</a>
<a className="text-foreground-variant hover:text-primary transition-colors font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em]" href="#roles">Roles</a>
</div>
<Link href="/login" className="bg-primary text-primary-foreground px-6 py-2.5 rounded-full font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] hover:opacity-80 transition-all active:scale-95">
                Get Started
            </Link>
</div>
</nav>
...
<h1 className="font-['Inter'] font-bold text-4xl md:text-[60px] md:leading-[72px] tracking-[-0.02em] text-foreground leading-tight">
                    Build Better Student Teams with <span className="text-primary">Trippy Tropa</span> and Task Assignment
                </h1>
<p className="font-['Inter'] font-normal text-[18px] leading-[28px] text-foreground-variant max-w-xl">
...
<Link href="/login" className="bg-primary text-primary-foreground px-8 py-4 rounded-xl font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all text-center">
                        Get Started
                    </Link>
<a href="#how-it-works" className="border border-border text-foreground px-8 py-4 rounded-xl font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] hover:bg-muted transition-all text-center">
                        Learn How It Works
                    </a>
</div>
</div>
...
<div className="absolute -top-10 -right-10 w-48 h-48 bg-primary/10 blur-3xl rounded-full"></div>
...
<h2 className="font-['Inter'] font-semibold text-3xl md:text-[36px] md:leading-[44px] tracking-[-0.01em] text-foreground">Group Work Shouldn't Be Random</h2>
<p className="font-['Inter'] font-normal text-[18px] leading-[28px] text-foreground-variant max-w-2xl mx-auto">Traditional group formation leads to friction and poor outcomes. We solve the common pitfalls of classroom collaboration.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-[24px]">
<div className="p-8 rounded-2xl bg-card border border-border-variant/30 shadow-sm hover:shadow-md transition-shadow">
...
<p className="text-foreground-variant">Top performers often end up in the same group, while others struggle without guidance or leadership.</p>
</div>
<div className="p-8 rounded-2xl bg-card border border-border-variant/30 shadow-sm hover:shadow-md transition-shadow">
...
<p className="text-foreground-variant">Tasks are often assigned to students who lack the specific skills required, leading to frustration and delays.</p>
</div>
<div className="p-8 rounded-2xl bg-card border border-border-variant/30 shadow-sm hover:shadow-md transition-shadow">
...
<p className="text-foreground-variant">The "Free Rider" problem persists when workloads aren't tracked or assigned based on fair time estimates.</p>
</div>
</div>
</div>
</section>

<section className="py-20 md:py-[120px] bg-background-container-low overflow-hidden" id="how-it-works">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
<h2 className="font-['Inter'] font-semibold text-3xl md:text-[36px] md:leading-[44px] tracking-[-0.01em] text-foreground text-center mb-16">A Smarter Way to Manage Group Projects</h2>
<div className="relative">
...
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">1</div>
<h4 className="font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] font-bold">Create Classroom</h4>
</div>
<div className="text-center space-y-4">
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">2</div>
<h4 className="font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] font-bold">Join &amp; Profile</h4>
</div>
<div className="text-center space-y-4">
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">3</div>
<h4 className="font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] font-bold">Skill Assessment</h4>
</div>
<div className="text-center space-y-4">
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">4</div>
<h4 className="font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] font-bold">Intelligent Grouping</h4>
</div>
<div className="text-center space-y-4">
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">5</div>
<h4 className="font-['Inter'] font-medium text-[14px] leading-[20px] tracking-[0.01em] font-bold">Task Optimization</h4>
</div>
<div className="text-center space-y-4">
<div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto shadow-lg">6</div>
...
<div>
<h2 className="font-['Inter'] font-semibold text-3xl md:text-[36px] md:leading-[44px] tracking-[-0.01em] mb-6">Interactive <span className="text-primary">Group Draft Board</span></h2>
<p className="font-['Inter'] font-normal text-[18px] leading-[28px] text-foreground-variant mb-8">
...
<div className="p-8 bg-background-container rounded-3xl">
<div className="grid grid-cols-3 gap-4 mb-8">
<div className="bg-card p-4 rounded-xl shadow-sm text-center border border-primary/20">
<p className="font-['Inter'] font-semibold text-[12px] leading-[16px] tracking-[0.05em] font-bold text-primary">Anna</p>
...
<div className="bg-card p-4 rounded-xl shadow-sm text-center border border-primary/20">
<p className="font-['Inter'] font-semibold text-[12px] leading-[16px] tracking-[0.05em] font-bold text-primary">Mia</p>
...
<span className="font-bold text-primary">264</span>
</div>
</div>
<div className="bg-primary/5 p-6 rounded-2xl border border-primary/10">
...
<div className="flex justify-between text-sm">
<span>Total Score:</span>
<span className="font-bold text-primary">262</span>
</div>
</div>
</div>
</div>
...
<section className="py-20 md:py-[120px] bg-background-container-low">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
<div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
...
<thead>
<tr className="border-b border-border-variant">
...
<tbody>
<tr>
<td className="py-3 font-bold text-primary">Anna</td>
<td className="py-3">2h</td>
<td className="py-3 bg-primary/10 rounded-lg text-primary font-bold">1h</td>
<td className="py-3">4h</td>
</tr>
<tr>
<td className="py-3 font-bold text-primary">John</td>
<td className="py-3 bg-primary/10 rounded-lg text-primary font-bold">2h</td>
<td className="py-3">3h</td>
<td className="py-3">5h</td>
</tr>
<tr>
<td className="py-3 font-bold text-primary">Mia</td>
<td className="py-3">4h</td>
<td className="py-3">2h</td>
<td className="py-3 bg-primary/10 rounded-lg text-primary font-bold">1h</td>
</tr>
...
<div className="mt-8 p-4 bg-primary text-primary-foreground rounded-xl text-center font-bold">
                        Fair Workload Distribution: Optimal Time 4h Total
                    </div>
</div>
<div className="order-1 lg:order-2">
<h2 className="font-['Inter'] font-semibold text-3xl md:text-[36px] md:leading-[44px] tracking-[-0.01em] mb-6">Collaborative <span className="text-primary">Estimation Matrix</span></h2>
<p className="font-['Inter'] font-normal text-[18px] leading-[28px] text-foreground-variant mb-8">
...
<p className="text-sm text-foreground-variant">Visualizes everyone's capacity.</p>
</div>
</div>
<div className="flex items-start gap-3">
...
<p className="text-sm text-foreground-variant">Officers assign based on data.</p>
</div>
</div>
</div>
</div>
...
<section className="py-20 md:py-[120px] bg-card" id="features">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
...
<div className="md:col-span-2 p-8 rounded-3xl bg-background-container-low border border-border-variant/30 flex flex-col justify-between">
<div>
<span className="material-symbols-outlined text-primary mb-4">school</span>
<h3 className="font-['Inter'] font-semibold text-[24px] leading-[32px] mb-2">Classroom Management</h3>
<p className="text-foreground-variant">Centralized hub for all your group projects. Manage multiple classes, enroll students, and monitor progress from a single dashboard.</p>
</div>
<div className="mt-8 p-4 bg-card rounded-xl shadow-sm">
<div className="flex justify-between items-center mb-2">
<span className="text-sm font-bold">CS101: Web Dev</span>
<span className="text-xs text-primary px-2 py-0.5 bg-primary/10 rounded-full">Active</span>
</div>
<div className="w-full bg-background-container rounded-full h-2">
<div className="bg-primary h-2 rounded-full w-3/4"></div>
</div>
</div>
</div>
<div className="p-8 rounded-3xl bg-background-container border border-border-variant/30">
...
<p className="text-foreground-variant text-sm">Dynamic profiling based on past performance and self-assessments.</p>
</div>
...
<p className="text-primary-foreground/80 text-sm">Real-time drag-and-drop workflow with GitHub link submissions.</p>
</div>
<div className="p-8 rounded-3xl border border-border-variant/30">
...
<p className="text-muted-foreground text-sm">Monitor At Risk Students and track Class Average Scores in real-time.</p>
</div>
<div className="md:col-span-2 p-8 rounded-3xl bg-accent border border-border/30 flex items-center gap-8">
<div className="flex-1">
<h3 className="font-['Inter'] font-semibold text-[24px] leading-[32px] mb-2">Student Officer Roles</h3>
<p className="text-muted-foreground">Empower top-performing students by promoting them to Student Officers to help manage groups, verify tasks, and lead their peers.</p>
</div>
<div className="hidden sm:flex w-32 h-32 bg-primary/20 rounded-full items-center justify-center">
<span className="material-symbols-outlined text-primary text-5xl" style={{ fontVariationSettings: "'FILL' 1" }}>military_tech</span>
</div>
</div>
<div className="p-8 rounded-3xl border border-border-variant/30">
...
<p className="text-foreground-variant text-sm">Automatic nudges for lagging tasks and missed milestones.</p>
</div>
</div>
</div>
</section>

<section className="py-20 md:py-[120px] bg-background" id="roles">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-[24px]">
<div className="p-8 bg-card rounded-3xl shadow-sm border border-border/20 hover:-translate-y-2 transition-transform">
...
<div className="p-8 bg-card rounded-3xl shadow-sm border border-border/20 hover:-translate-y-2 transition-transform">
<div className="w-14 h-14 bg-muted text-muted-foreground rounded-2xl flex items-center justify-center mb-6">
...
<section className="py-20 md:py-[120px] bg-card" id="pricing">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
...
<div className="p-10 rounded-3xl bg-background-container-low relative">
<span className="material-symbols-outlined text-primary/20 text-7xl absolute top-8 left-8">format_quote</span>
<div className="relative z-10">
<p className="font-['Inter'] font-normal text-[18px] leading-[28px] mb-8 italic text-foreground-variant">
...
<div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center"><span className="material-symbols-outlined text-primary">school</span></div>
<div>
<p className="font-bold">Dr. Sarah Mitchell</p>
<p className="text-sm text-foreground-variant">Professor of Computer Science</p>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-4">
<div className="w-12 h-12 rounded-full bg-secondary/10 flex items-center justify-center"><span className="material-symbols-outlined text-secondary">face</span></div>
<div>
<p className="font-bold">Liam Peterson</p>
<p className="text-sm text-foreground-variant">3rd Year Student</p>
</div>
</div>
</div>
</div>
...
<Link href="/login" className="bg-card text-primary px-10 py-5 rounded-2xl font-bold hover:scale-105 transition-transform text-center">
                        Create a Classroom
                    </Link>
</div>
</div>
...
<footer className="w-full py-20 md:py-[120px] bg-background-container-low border-t border-border-variant/30">
<div className="max-w-[1200px] mx-auto px-6 md:px-[48px]">
...
<p className="text-foreground-variant max-w-xs">Empowering education through intelligent collaborative tools and algorithmic efficiency.</p>
</div>
<div className="space-y-4">
<h4 className="font-bold">Product</h4>
<ul className="space-y-2">
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Features</a></li>
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">How it Works</a></li>
</ul>
</div>
<div className="space-y-4">
<h4 className="font-bold">Company</h4>
<ul className="space-y-2">
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">About Us</a></li>
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Careers</a></li>
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Blog</a></li>
</ul>
</div>
<div className="space-y-4">
<h4 className="font-bold">Legal</h4>
<ul className="space-y-2">
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Privacy Policy</a></li>
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Terms of Service</a></li>
<li><a className="text-foreground-variant hover:text-primary transition-colors text-label-md" href="#">Cookie Policy</a></li>
</ul>
</div>
<div className="space-y-4">
<h4 className="font-bold">Social</h4>
<div className="flex gap-4">
<a className="w-10 h-10 rounded-full bg-background-container flex items-center justify-center hover:bg-primary/10 transition-colors" href="#">
...
<div className="border-t border-border/20 pt-8 text-center text-foreground-variant text-label-md">
